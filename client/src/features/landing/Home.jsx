...
// // Creates a premium 3D tilt effect on mouse hover
// const StoryCard = ({
//   quote,
//   name,
//   role,
...
//       boxShadow: `${-rotateY}px ${rotateX}px 30px rgba(0,0,0,0.15)`,
...
//         style={style}
//         className="relative flex h-full cursor-crosshair flex-col justify-center overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#c81e1e] to-[#991515] p-10 text-white"
//       >
...
//           stroke="currentColor"
//           strokeWidth="2"
//           className="relative z-10 mb-6 text-red-200"
//           viewBox="0 0 24 24"
//         >
//           <path
//             strokeLinecap="round"
...
//           ></path>
//         </svg>
//         <h3 className="relative z-10 mb-4 text-6xl font-extrabold tracking-tighter drop-shadow-lg lg:text-7xl">
//           {metricValue}
//         </h3>
...
//       onMouseLeave={handleMouseLeave}
//       style={style}
//       className="relative flex h-full cursor-crosshair flex-col justify-between overflow-hidden rounded-[2rem] border border-gray-100 bg-white/80 p-10 backdrop-blur-xl"
//     >
//       <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-transparent to-gray-50/50"></div>
...
//           alt={name}
//           className="h-14 w-14 rounded-full bg-gray-100 shadow-sm ring-4 ring-gray-50"
//         />
//         <div>
...
// const Home = () => {
//   return (
//     <div className="min-h-screen overflow-x-hidden bg-[#fafafa] font-sans text-gray-900 selection:bg-red-200 selection:text-red-900">
//       <style>{`
//         /* Core Physics & Keyframes */
//         @keyframes pulse-heart {
//           0% { transform: scale(1); filter: drop-shadow(0 0 0 rgba(200,30,30,0)); }
//           15% { transform: scale(1.08); filter: drop-shadow(0 0 20px rgba(200,30,30,0.4)); }
//           30% { transform: scale(1); filter: drop-shadow(0 0 0 rgba(200,30,30,0)); }
//           45% { transform: scale(1.08); filter: drop-shadow(0 0 20px rgba(200,30,30,0.4)); }
//           60% { transform: scale(1); filter: drop-shadow(0 0 0 rgba(200,30,30,0)); }
//           100% { transform: scale(1); filter: drop-shadow(0 0 0 rgba(200,30,30,0)); }
//         }
//         @keyframes ecgFlow {
...
//           20% { opacity: 0.8; transform: translateY(50px) scale(1); }
...
//         /* Utility Classes */
//         .animate-pulse-heart {
//           animation: pulse-heart 1.8s infinite cubic-bezier(0.4, 0, 0.6, 1);
...
//         }
//         .animate-radar {
//           animation: radar-ping 3s infinite cubic-bezier(0.0, 0, 0.2, 1);
//         }
...
//       {/* 1. HERO SECTION */}
//       <section className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 pt-16 pb-24 lg:grid-cols-2 lg:gap-8">
//         {/* Left Content */}
//         <div className="relative z-10 order-2 max-w-xl lg:order-1">
//           <div className="pointer-events-none absolute -top-10 -left-10 h-32 w-32 rounded-full bg-red-100 opacity-50 blur-3xl"></div>

//           <div className="animate-float-1 mb-6 inline-block rounded-full border border-red-100 bg-red-50 px-4 py-1.5 text-xs font-bold tracking-widest text-[#c81e1e] uppercase">
//             Life-Saving Network Active
//           </div>
...
//             </span>
//           </h1>
//           <p className="mb-10 max-w-md text-lg leading-relaxed text-gray-500 md:text-xl">
//             VitalPulse connects urgent blood needs with volunteer donors in
//             real-time. We've optimized the bridge between life and emergency.
//           </p>
//           <div className="mb-12 flex flex-wrap items-center gap-4">
//             <Link
//               to="/registration"
//               className="group relative overflow-hidden rounded-xl bg-[#c81e1e] px-8 py-4 text-center font-bold text-white shadow-[0_8px_20px_rgb(200,30,30,0.2)] transition-all hover:-translate-y-1 hover:shadow-[0_15px_30px_rgb(200,30,30,0.4)]"
//             >
...
//             <Link
//               to="/donor"
//               className="rounded-xl border-2 border-blue-100 bg-white px-8 py-4 text-center font-bold text-blue-900 transition-all hover:-translate-y-1 hover:border-blue-300 hover:bg-blue-50 hover:shadow-lg"
//             >
//               Find Blood
//             </Link>
//           </div>

//           <div className="animate-float-2 flex max-w-fit items-center gap-4 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
...
//               Joined by{' '}
//               <span className="text-base font-extrabold text-[#c81e1e]">
//                 12,000+
//               </span>
//               <br />
...
//         {/* Right Animation */}
//         <div className="relative order-1 flex aspect-square max-h-[500px] w-full items-center justify-center lg:order-2">
//           <div className="absolute inset-0 flex items-center justify-center overflow-hidden rounded-[3rem] border border-white bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] shadow-2xl">
//             <svg
...
//                 >
//                   <circle cx="2" cy="2" r="1.5" fill="#c81e1e" />
//                 </pattern>
//               </defs>
...
//             <svg
//               viewBox="0 0 800 400"
//               className="relative z-10 h-full w-full scale-125 drop-shadow-2xl md:scale-100"
//             >
//               <defs>
//                 <radialGradient id="glow" cx="50%" cy="50%" r="50%">
//                   <stop offset="0%" stopColor="#c81e1e" stopOpacity="0.25" />
...
//                 strokeLinecap="round"
//                 strokeLinejoin="round"
//                 className="animate-ecg drop-shadow-md"
//               />
//             </svg>
//           </div>
//         </div>
...
//       {/* 2. THE LIFE CHAIN (Colorful & Animated) */}
//       <section className="relative mx-auto max-w-7xl px-6 py-24 text-center">
//         <div className="absolute top-0 left-1/2 h-20 w-[2px] -translate-x-1/2 bg-gradient-to-b from-transparent to-red-200"></div>
//         <h2 className="relative z-10 mb-6 text-4xl font-extrabold tracking-tight text-gray-900 md:text-5xl">
//           The Life Chain
//         </h2>
//         <p className="relative z-10 mx-auto mb-16 max-w-xl text-lg text-gray-500">
//           Our intelligent matching system turns hours of waiting into minutes of
//           action. Watch how a request becomes a saved life.
//         </p>

//         <div className="relative z-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
//           {/* Card 1: Request Created (Red/Rose Tint) */}
//           <div className="group animate-float-1 rounded-[2rem] border border-red-100 bg-gradient-to-br from-rose-50/80 to-red-50/80 p-8 text-left shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-red-100">
//             <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-[#c81e1e] shadow-sm transition-transform duration-300 group-hover:scale-110">
//               {/* Medical Form / Pulse Icon */}
//               <svg
//                 width="24"
//                 height="24"
//                 fill="none"
...
//               Hospitals or families initiate an urgent request specifying blood
//               type and exact medical needs.
//             </p>
//           </div>

//           {/* Card 2: Nearby Alert (Blue Tint) */}
//           <div className="group animate-float-2 relative rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50/80 to-indigo-50/80 p-8 text-left shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-100">
//             <div className="absolute top-6 right-6 h-16 w-16 rounded-full bg-blue-400 opacity-0 blur-2xl transition-opacity group-hover:opacity-20"></div>
//             <div className="relative mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-blue-600 shadow-sm transition-transform duration-300 group-hover:scale-110">
//               <span className="absolute inset-0 animate-ping rounded-2xl border border-blue-400 opacity-30"></span>
//               <svg
//                 width="24"
//                 height="24"
//                 fill="currentColor"
...
//             </h3>
//             <p className="text-sm leading-relaxed font-medium text-gray-600">
//               Our algorithm instantly pings compatible donors currently located{' '}
...
//           {/* Card 3: Donor Connects (Amber/Orange Tint) */}
//           <div className="group animate-float-3 rounded-[2rem] border border-orange-100 bg-gradient-to-br from-amber-50/80 to-orange-50/80 p-8 text-left shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-orange-100">
//             <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-orange-600 shadow-sm transition-transform duration-300 group-hover:scale-110">
//               {/* Connect/Chat/Map Icon */}
//               <svg
//                 width="24"
//                 height="24"
//                 fill="none"
...
//             </h3>
//             <p className="text-sm leading-relaxed font-medium text-gray-600">
//               Donors instantly view the request details, can call or message the
//               family, and get direct map navigation.
//             </p>
//           </div>

//           {/* Card 4: Life Saved (Deep Red Gradient) */}
//           <div className="group animate-float-4 relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#c81e1e] to-[#991515] p-8 text-left shadow-[0_15px_40px_rgb(200,30,30,0.3)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_25px_50px_rgb(200,30,30,0.4)]">
//             <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
//             <div className="relative z-10 mb-6 flex h-14 w-14 items-center justify-center rounded-2xl border border-white/30 bg-white/20 text-white backdrop-blur-md transition-transform duration-300 group-hover:scale-110">
//               <svg
//                 width="24"
//                 height="24"
//                 fill="currentColor"
...
//               Donation completed. Impact logged. Lives changed. The pulse
//               continues stronger.
//             </p>
//           </div>
//         </div>
...
//       {/* 3. PRECISION IN EVERY CONNECTION */}
//       <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 py-12 lg:grid-cols-2">
//         <div className="order-2 pr-0 lg:order-1 lg:pr-10">
//           <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-xs font-bold text-blue-600">
//             <span className="h-2 w-2 animate-pulse rounded-full bg-blue-600"></span>
//             Location Intelligence
//           </div>
//           <h2 className="mb-6 text-4xl leading-[1.1] font-extrabold tracking-tight text-gray-900 md:text-5xl">
//             Precision in Every <br />
//             <span className="bg-gradient-to-r from-[#c81e1e] to-red-500 bg-clip-text text-transparent">
//               Connection
//             </span>
//           </h2>
//           <p className="mb-10 text-lg leading-relaxed text-gray-500">
//             Our geo-fencing technology creates a protective web across the city.
//             When a call for help goes out, we don't broadcast to everyone—we
//             signal the heroes closest to the scene.
//           </p>

//           <div className="space-y-8 rounded-[2rem] border border-gray-100 bg-white p-8 shadow-sm">
//             <div className="group flex gap-5">
//               <div className="mt-1 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-red-50 transition-colors duration-300 group-hover:bg-[#c81e1e] group-hover:text-white">
//                 <svg
//                   width="24"
//                   height="24"
//                   fill="none"
...
//                   Real-time donor locations tracked with privacy-first
//                   encryption to protect identities.
//                 </p>
//               </div>
//             </div>
//             <div className="h-px w-full bg-gray-100"></div>
//             <div className="group flex gap-5">
//               <div className="mt-1 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-blue-50 transition-colors duration-300 group-hover:bg-blue-600 group-hover:text-white">
//                 <svg
//                   width="24"
//                   height="24"
//                   fill="none"
...
//               <div>
//                 <h4 className="text-xl font-bold text-gray-900">
//                   Type Match Filtering
//                 </h4>
//                 <p className="mt-2 text-base font-medium text-gray-500">
//                   Instant compatibility check between donor types and urgent
//                   hospital needs.
//                 </p>
//               </div>
//             </div>
...
//         {/* Highly Interactive Map Visual */}
//         <div className="group relative order-1 flex h-[400px] items-center justify-center overflow-hidden rounded-[3rem] border-8 border-white bg-gradient-to-br from-[#b6e3e9] to-[#8ac9d1] p-4 shadow-2xl md:h-[500px] lg:order-2">
//           <div className="absolute inset-0 opacity-30 mix-blend-overlay">
//             <svg
//               viewBox="0 0 800 600"
//               className="h-full w-full fill-current text-teal-900"
//             >
//               <path d="M150,150 Q200,100 250,180 T350,200 T400,100 T500,200 T600,150 T650,250 T550,350 T450,400 T300,300 T200,400 T100,250 Z" />
//               <path d="M600,400 Q650,350 700,420 T750,500 T650,550 T550,450 Z" />
//             </svg>
//           </div>
...
//               <div className="animate-radar absolute h-48 w-48 rounded-full border-2 border-[#c81e1e] mix-blend-color-burn md:h-[22rem] md:w-[22rem]"></div>

//               {/* Dynamic Popup */}
//               <div className="absolute -top-20 left-6 z-30 flex min-w-max items-center gap-4 rounded-2xl border border-white bg-white/90 px-5 py-3 shadow-xl backdrop-blur transition-transform duration-500 group-hover:-translate-y-2">
//                 <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-red-100 to-red-200 text-sm font-black text-[#c81e1e] shadow-inner">
//                   O+
//                 </div>
//                 <div>
//                   <div className="mb-1 text-base leading-none font-extrabold text-gray-900">
//                     Donor Found
//                   </div>
...
//               <div className="relative z-20 h-6 w-6 rounded-full bg-[#c81e1e] shadow-[0_0_0_8px_rgba(200,30,30,0.25)]">
//                 <div className="absolute inset-0 animate-ping rounded-full bg-white opacity-50"></div>
//               </div>
//             </div>

//             {/* Surrounding Map Pins */}
//             <div className="animate-float-1 absolute top-[30%] left-[25%] z-10 h-4 w-4 rounded-full border-2 border-white bg-[#c81e1e] shadow-lg"></div>
//             <div className="animate-float-2 absolute bottom-[20%] left-[35%] z-10 h-5 w-5 rounded-full border-2 border-white bg-[#c81e1e] shadow-lg"></div>
//             <div className="animate-float-3 absolute top-[40%] right-[20%] z-10 h-4 w-4 rounded-full border-2 border-white bg-[#c81e1e] shadow-lg"></div>
//           </div>
//         </div>
//       </section>
...
//         <div className="pointer-events-none absolute top-1/2 left-0 -z-10 h-[300px] w-full -skew-y-3 bg-red-50/50"></div>
...
//               Real people. Real seconds. Real survival.
//             </p>
//           </div>
//           <div className="mt-6 hidden gap-4 md:mt-0 md:flex">
//             {/* Decorative Elements */}
//             <div
//               className="flex h-12 w-12 animate-spin items-center justify-center rounded-full border-2 border-red-200"
//               style={{ animationDuration: '10s' }}
//             >
//               <div className="absolute top-0 h-2 w-2 rounded-full bg-[#c81e1e]"></div>
//             </div>
//           </div>
//         </div>
...
//             <StoryCard
//               quote="I received a match notification while getting coffee. Within 20 minutes, I was at the center. Knowing I helped save a life before noon is incredible."
//               name="Marcus Chen"
...
//           {/* Metric Card (Center, Red, 3D) */}
//           <div className="h-[350px] lg:-translate-y-8">
//             <StoryCard
//               isMetric={true}
//               metricValue="20m"
//               metricLabel="Average donor arrival time in critical emergency cases last year."
//             />
//           </div>
...
//           <div className="h-[350px]">
//             <StoryCard
//               quote="The app made it so seamless. I didn't have to call around or panic. VitalPulse found a match for my father in minutes."
//               name="Sarah J."
...
//       {/* 5. CRAZY CTA SECTION */}
//       <section className="mx-auto mb-20 max-w-7xl px-6 py-20">
//         <div className="group relative flex min-h-[550px] flex-col items-center justify-center overflow-hidden rounded-[3rem] border border-red-400 bg-[#c81e1e] p-10 text-center text-white shadow-[0_30px_60px_rgb(200,30,30,0.3)] md:p-20">
//           {/* Abstract Deep Background & Particles */}
//           <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent to-black/20"></div>

//           {/* Animated SVG Wave Background */}
//           <div className="pointer-events-none absolute bottom-0 left-0 h-[60%] w-full overflow-hidden">
//             <svg
//               viewBox="0 0 1000 300"
//               className="animate-float-1 h-full w-[200%] fill-current text-[#991515]"
//               preserveAspectRatio="none"
//             >
//               <path d="M0,300 C200,100 400,200 600,50 800,200 1000,100 1000,300 Z" />
//             </svg>
//             <svg
//               viewBox="0 0 1000 300"
//               className="animate-float-3 absolute bottom-0 -left-1/2 h-full w-[200%] fill-current text-[#7a1010]/80"
//               preserveAspectRatio="none"
//             >
//               <path d="M0,300 C300,50 500,250 700,100 900,250 1000,100 1000,300 Z" />
//             </svg>
//           </div>

//           {/* Floating Particles mimicking blood cells/energy */}
//           {[...Array(6)].map((_, i) => (
//             <div
//               key={i}
...
//                 bottom: `-10%`,
//                 animation: `particleUp ${4 + Math.random() * 4}s linear infinite ${Math.random() * 2}s`,
//               }}
//             ></div>
//           ))}
...
//             {/* Glowing Icon */}
//             <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-full border border-white/20 bg-white/10 shadow-[0_0_30px_rgba(255,255,255,0.2)] backdrop-blur-xl transition-transform duration-500 group-hover:scale-110">
//               <svg
//                 width="40"
//                 height="40"
//                 fill="currentColor"
...
//             <h2 className="mb-8 text-5xl leading-[1.05] font-black tracking-tighter drop-shadow-xl md:text-6xl lg:text-[5rem]">
//               You could be the <br className="hidden md:block" /> reason someone{' '}
//               <br /> survives today.
//             </h2>
//             <p className="mb-12 max-w-2xl text-xl leading-relaxed font-medium text-red-100 drop-shadow-md md:text-2xl">
//               Every drop donated is a heartbeat continued. Join our network of
//               life-savers and make an impact that lasts forever.
//             </p>

//             {/* The exact requested button code plus visual enhancements */}
//             <div className="relative z-30 flex w-full flex-wrap justify-center gap-6">
//               <Link
//                 to="/emergency"
//                 className="rounded-xl bg-white px-10 py-5 text-center text-xl font-extrabold text-[#c81e1e] shadow-[0_10px_30px_rgba(0,0,0,0.2)] ring-4 ring-white/20 transition-all hover:-translate-y-1 hover:bg-gray-50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)]"
//               >
//                 Donate Now
//               </Link>
//             </div>
...
//       {/* 6. BEAUTIFUL FOOTER */}
//       <footer className="relative overflow-hidden border-t border-gray-200 bg-white pt-16 pb-8">
//         {/* Animated Top Border Line */}
//         <div className="absolute top-0 left-0 h-1 animate-[glowLine_3s_ease-in-out_infinite] bg-gradient-to-r from-transparent via-[#c81e1e] to-transparent"></div>
...
//             Connecting life and emergency through real-time logistics, making
//             every drop matter.
//           </p>
...
//               className="flex h-14 w-14 items-center justify-center rounded-2xl border border-gray-200 bg-gray-50 text-gray-600 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-red-200 hover:bg-red-50 hover:text-[#c81e1e]"
...
//               className="flex h-14 w-14 items-center justify-center rounded-2xl border border-gray-200 bg-gray-50 text-gray-600 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-600"
...
//             © {new Date().getFullYear()} VitalPulse by Nasir Yousuf. All rights
//             reserved.
//           </p>
//         </div>
//       </footer>
        ...
        >
          ...
          <div className="relative flex h-full w-full items-center justify-center">
            ...
            <div className="absolute top-1/2 left-[45%] z-20 flex items-center justify-center">
              ...
              {/* Dynamic Popup */}
              <div className="absolute -top-20 left-6 z-30 flex min-w-max items-center gap-4 rounded-2xl border border-white bg-white/90 px-5 py-3 shadow-xl backdrop-blur transition-transform duration-700 ease-out group-hover:-translate-y-3">
                <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-red-100 to-red-200 text-sm font-black text-[#c81e1e] shadow-inner">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1 text-xs font-bold text-[#c81e1e]">
                    <span className="h-2 w-2 animate-ping rounded-full bg-[#c81e1e]"></span>
                    Routing connection...
                  </div>
                </div>
              </div>
